      ...
      <div className="w-[50%] h-[70%] bg-slate-500 rounded-2xl flex-row justify-center p-[50px] overflow-y-auto">
        ...
        <Form {...form}>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <MyInput control={form.control} name="fullname" label="Full name" formMessage={formSchema} className="w-[50%] mb-3"/>

                <MyInput control={form.control} name="username" label="Username" formMessage={formSchema} className="w-[50%] mb-3"/>

                <MyInput control={form.control} name="email" label="E-mail" type="email" formMessage={formSchema} className="w-[50%] mb-3"/>
